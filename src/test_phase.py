...
class TestPhase(TestCase):
    ...
    def test_constructors(self):
        game = MockGame()
        phase = game.phase
        self.assertIsInstance(phase, pl2.PhaseI)
        phase = phase.next
        self.assertIsInstance(phase, pl2.PhaseII)
        phase = phase.next
        self.assertIsInstance(phase, pl2.PhaseIII)
        phase = phase.next
        self.assertIsInstance(phase, pl2.PhaseIV)
        phase = phase.next
        self.assertIsInstance(phase, pl2.PhaseI)
    ...
    def test_phase1_end_phase(self):
        ...
        self.assertIsInstance(game.phase, pl2.PhaseII)
    ...
    def test_phase2_end_phase(self):
        ...
        game.phase.update(**d)
        self.assertEqual(game.error, None)
        self.assertIsInstance(game.phase, pl2.PhaseIII)
    ...
    def test_phase3_end_phase(self):
        ...
        game.phase.update(**d)
        self.assertEqual(game.error, None)
        self.assertIsInstance(game.phase, pl2.PhaseIV)
        self.assertEqual(len(game.deck), 131)
        self.assertEqual(game.offering, [(Card.cards[2], 1), (Card.cards[1], 1), (Card.cards[0], 1)])
        ...
        d = {'action': 'next', 'args': None}
        game.phase.update(**d)
        self.assertIsInstance(game.phase, pl2.PhaseGameOver)
        self.assertEqual(game.players[0].coins, 1)
        self.assertEqual(game.players[1].coins, 2)
    ...
    def test_phase4_end_phase(self):
        ...
        game.phase.update(**d)
        self.assertEqual(game.error, None)
        self.assertIsInstance(game.phase, pl2.PhaseI)
        self.assertEqual(game.phase.next.next.next.done_drawing, False)
